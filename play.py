"""
A rock, paper, scissors game written in Python 3
...
def compare(user, computer):
    ...
    # If so, then rock wins. If not, the computer wins
    ...
    # If so, then scissors wins. If not, the computer wins
    ...
    # If so, then paper wins. If not, the computer wins
...
def game_loop():
    # Get the name of the player so we can thanks them for playing on exit.
